...
class AdminRideDetailsWidget extends StatefulWidget {
  final String tripId;
  const AdminRideDetailsWidget({Key? key, required this.tripId})
      : super(key: key);

  static String routeName = 'adminRideDetails';
  static String routePath = '/adminRideDetails';

  @override
  State<AdminRideDetailsWidget> createState() => _AdminRideDetailsWidgetState();
}

class _AdminRideDetailsWidgetState extends State<AdminRideDetailsWidget> {
  late AdminRideDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminRideDetailsModel());
    loadUsers();
  }
          ...
          child: Column(
            ...
            children: [
              Consumer<TripProvider>(builder: (context, tripProvider, child) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () =>
                              tripProvider.loadTripByTripId(widget.tripId),
                          child: Text('Retry'),
                        ),
                      ],
                    ),
                ...
                final trip = tripProvider.loadTripByTripId(widget.tripId);
