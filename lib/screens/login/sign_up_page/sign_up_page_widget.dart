...
import 'package:ride_link_carpooling/providers/auth_provider.dart';
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          autofocus: false,
                          obscureText: !_model.passwordlTextFieldVisibility1,
                          decoration: InputDecoration(
                            isDense: true,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelLarge
                            ...
                            suffixIcon: InkWell(
                              onTap: () => safeSetState(
                                () => _model.passwordlTextFieldVisibility1 =
                                    !_model.passwordlTextFieldVisibility1,
                              ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          autofocus: false,
                          obscureText: !_model.passwordlTextFieldVisibility2,
                          decoration: InputDecoration(
                            isDense: true,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelLarge
                            ...
                            suffixIcon: InkWell(
                              onTap: () => safeSetState(
                                () => _model.passwordlTextFieldVisibility2 =
                                    !_model.passwordlTextFieldVisibility2,
                              ),
                              focusNode: FocusNode(skipTraversal: true),
                              child: Icon(
                      ...
                      children: [
                        FFButtonWidget(
                            onPressed: () async {
                              ...
                              final password = _model.passwordlTextFieldTextController1!.text.trim();
                              final confirmPassword = _model.passwordlTextFieldTextController2!.text.trim();
                              ...
                              try {
                                ...
                                if (user != null && !user.emailVerified) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('Verification link sent to $email! Please check your inbox.')),
                                  );
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Invalid Account: ${e.toString()}')),
                                );
                              }
                            },
                          text: 'Sign up',
