...
class _UserProfilePageWidgetState extends State<UserProfilePageWidget> {
  ...
  // Add variables for profile picture
  ...
  Future<void> _pickAndUploadImage(ImageSource source) async {
    try {
      ...
      if (image != null) {
        ...
        // Update local state
        setState(() {
          selectedProfilePictureUrl = downloadUrl;
        });
                    ...
                    Stack(
                      children: [
                        ...
                        Container(
                          ...
                          child: selectedProfilePictureUrl != null
                              ? ClipOval(
                                  child: CachedNetworkImage(
                                    imageUrl: selectedProfilePictureUrl!,
                                    fit: BoxFit.cover,
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            final firstName = _model
                                    ...
                                    .trim() ??
                                '';
                            final secondName = _model
                                    .emailTextFieldTextController2?.text
                                    .trim() ??
                                '';
                            final nic = _model
                                    .passwordlTextFieldTextController1?.text
                                    .trim() ??
                                '';
                            final phone = _model
                                    .passwordlTextFieldTextController2?.text
                                    .trim() ??
                                '';
                            ...
                            if (firstName.isEmpty ||
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content: Text(
                                        'Please fill out all fields and select a gender.')),
                              );
                              return;
                            }
                            ...
                            final newUser = UserModel(
                              ...
                              profilePictureUrl:
                                  selectedProfilePictureUrl, // Add this line
                            );
