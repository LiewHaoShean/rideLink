...
class VerificationPageWidget extends StatefulWidget {
  ...
  /// type of verification (resetPass/signUp)
  final String? type;
  final String email;
              ...
              Padding(
                ...
                child: PinCodeTextField(
                  ...
                  pinTheme: PinTheme(
                    ...
                    activeColor: Color(0xFFB5B5B5),
                    inactiveColor: Color(0xFFEDEDED),
                    selectedColor: Color(0xFFB5B5B5),
                    activeFillColor: Color(0xFFB5B5B5),
                    inactiveFillColor: Color(0xFFEDEDED),
                    selectedFillColor: Color(0xFFB5B5B5),
                  ),
