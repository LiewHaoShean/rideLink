...
import 'create_ride_home_model.dart';
export 'create_ride_home_model.dart';
...
class CreateRideHomeWidget extends StatefulWidget {
  ...
  static String routeName = 'createRideHome';
  static String routePath = '/createRideHome';

  @override
  State<CreateRideHomeWidget> createState() => _CreateRideHomeWidgetState();
}

class _CreateRideHomeWidgetState extends State<CreateRideHomeWidget> {
  late CreateRideHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateRideHomeModel());
