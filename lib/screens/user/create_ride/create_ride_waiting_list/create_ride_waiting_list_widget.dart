...
class _CreateRideWaitingListWidgetState extends State<CreateRideWaitingListWidget> with WidgetsBindingObserver {
          ...
          for (final passenger in passengers) {
            ...
            if (passengerId != null) {
              try {
                ...
                if (userDoc.exists) {
                  passengerName =
                      userDoc.data()?['name'] ?? 'Unknown Passenger';
                }
              } catch (e) {
                print(
                    '[ERROR] Failed to fetch name for passengerId $passengerId: $e');
              }
            }
  ...
  Future<void> _updatePassengerStatus(
      String passengerId, String rideId, String newStatus) async {
    ...
    debugPrint(
        '[SUCCESS] Updated passenger $passengerId to status: $newStatus');
  }
                                      ...
                                      final shouldExit = await showDialog<bool>(
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            ...
                                            content: const Text(
                                                'Do you really want to quit? This ride will be discarded.'),
                                            actions: [
                                              TextButton(
                                                onPressed: () =>
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FutureBuilder<
                                              ...
                                              builder: (context, fromSnap) {
                                                if (fromSnap.connectionState ==
                                                    ConnectionState.waiting) {
                                                  return const CircularProgressIndicator();
                                                }

                                                final fromDoc = fromSnap.data
                                                            ?.docs.isNotEmpty ==
                                                        true
                  ...
                  children: [
                    StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final passengers =
                            tripData['passengers'] as List<dynamic>? ?? [];
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            FFButtonWidget(
                                              onPressed: () async {
                                                debugPrint(
                                                    'Accept pressed for $passengerId');
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                debugPrint(
                                                    'Reject pressed for $passengerId');
                                                await _updatePassengerStatus(
                                                    passengerId,
                                                    widget.rideId,
                                                    'rejected');
