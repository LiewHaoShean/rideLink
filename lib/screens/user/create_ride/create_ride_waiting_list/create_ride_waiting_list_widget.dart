...
class _CreateRideWaitingListWidgetState extends State<CreateRideWaitingListWidget> with WidgetsBindingObserver {
  ...
  Future<void> _deleteTempRide() async {
    final docRef = FirebaseFirestore.instance.collection('temp_rides').doc(widget.rideId);
    final doc = await docRef.get();
    if (doc.exists) {
      await docRef.delete();
      debugPrint('Temp ride ${widget.rideId} deleted on app exit.');
    }
  }
                                    ...
                                    children: [
                                      ...
                                      FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final from = data['from']['addressLine'] ?? 'Unknown';
                                          final to = data['to']['addressLine'] ?? 'Unknown';
