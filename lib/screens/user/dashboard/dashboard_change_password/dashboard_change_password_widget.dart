...
import 'dashboard_change_password_model.dart';
export 'dashboard_change_password_model.dart';

class DashboardChangePasswordWidget extends StatefulWidget {
  const DashboardChangePasswordWidget({super.key});

  static String routeName = 'dashboardChangePassword';
  static String routePath = '/dashboardChangePassword';

  @override
  State<DashboardChangePasswordWidget> createState() =>
      _DashboardChangePasswordWidgetState();
}

class _DashboardChangePasswordWidgetState
    extends State<DashboardChangePasswordWidget> {
  late DashboardChangePasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardChangePasswordModel());
  ...
  Future<void> _loadEmail() async {
    ...
    if (user != null) {
      setState(() {
        _model.emailTextFieldTextController?.text = user.email ?? '';
      });
    }
  }
