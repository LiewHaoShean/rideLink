...
import 'dashboard_transaction_details_model.dart';
export 'dashboard_transaction_details_model.dart';
import 'package:provider/provider.dart';
...
class DashboardTransactionDetailsWidget extends StatefulWidget {
  ...
  const DashboardTransactionDetailsWidget(
      {Key? key, required this.transactionId})
      : super(key: key);

  static String routeName = 'dashboardTransactionDetails';
  static String routePath = '/dashboardTransactionDetails';

  @override
  State<DashboardTransactionDetailsWidget> createState() =>
      _DashboardTransactionDetailsWidgetState();
}

class _DashboardTransactionDetailsWidgetState
    extends State<DashboardTransactionDetailsWidget> {
  late DashboardTransactionDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardTransactionDetailsModel());
    loadTransaction();
    loadTrips();
    // loadUsers();
  }
  ...
  // Widget to display a single passenger
  Widget _buildPassengerItem(PassengerStatus passenger) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        transaction?.userId == passenger.passengerId
                            ? Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Container(
          ...
          child: Column(
            ...
            children: [
              Consumer<TripProvider>(builder: (context, tripProvider, child) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        ElevatedButton(
                          onPressed: () => tripProvider
                              .loadTripByTripId(transaction?.rideId ?? ''),
                          child: Text('Retry'),
                        ),
                      ],
                    ),
                ...
                final trip =
                    tripProvider.loadTripByTripId(transaction?.rideId ?? '');
