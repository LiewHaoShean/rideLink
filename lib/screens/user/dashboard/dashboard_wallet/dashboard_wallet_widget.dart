...
class DashboardWalletWidget extends StatefulWidget {
  final String userId;
  const DashboardWalletWidget({Key? key, required this.userId})
      : super(key: key);
...
class _DashboardWalletWidgetState extends State<DashboardWalletWidget> {
  ...
  Future<void> loadUserDetails() async {
    _userDetails =
        await context.read<UserProvider>().getUserDetails(widget.userId);
    setState(() {});
  }

  Future<void> loadCards() async {
    await context.read<CardProvider>().fetchCardsByUserId(widget.userId);
  }

  Future<void> deleteCardById(String cardId) async {
    await context
        .read<CardProvider>()
        .deleteCardByCardId(cardId, widget.userId);
  }
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        (_userDetails?.credit ?? 0).toString(),
                                        style: FlutterFlowTheme.of(context)
                                            .headlineMedium
                                            .override(
                                              font: GoogleFonts.interTight(
                                                                  ...
                                                                  onTap: () {
                                                                    Navigator
                                                                      ...
                                                                      MaterialPageRoute(
                                                                        builder:
                                                                            (context) =>
                                                                                DashboardAddCardWidget(userId: widget.userId),
                                                                      ),
                                                                    );
                                                                  },
                                                                  child: Column(
                                                                      ...
                                                                      FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => DashboardAddCardWidget(userId: widget.userId),
                                                                            ),
                                                                          );
                                                                        },
                                                                      ),
