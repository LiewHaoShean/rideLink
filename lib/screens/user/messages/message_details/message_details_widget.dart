...
import 'package:ride_link_carpooling/models/message.dart'; // Added import for Message model
...
class MessageDetailsWidget extends StatefulWidget {
  ...
  static String routePath = '/messageDetails';
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        _receiver?.name ?? "Customer Service",
