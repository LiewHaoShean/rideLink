...
import 'create_ride_start_ride_model.dart';
export 'create_ride_start_ride_model.dart';

class CreateRideStartRideWidget extends StatefulWidget {
  const CreateRideStartRideWidget({super.key});
...
class _CreateRideStartRideWidgetState extends State<CreateRideStartRideWidget> {
  late CreateRideStartRideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateRideStartRideModel());
  }
