...
import 'vehicle_register_model.dart';
export 'vehicle_register_model.dart';

class VehicleRegisterWidget extends StatefulWidget {
  const VehicleRegisterWidget({super.key});

  static String routeName = 'vehicleRegister';
  static String routePath = '/vehicleRegister';

  @override
  State<VehicleRegisterWidget> createState() => _VehicleRegisterWidgetState();
}

class _VehicleRegisterWidgetState extends State<VehicleRegisterWidget> {
  late VehicleRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VehicleRegisterModel());
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  hintText:
                                                                      'Vehicle Identification Number (NIC)',
                                                                  hintStyle: FlutterFlowTheme.of(
                                                                          context)
                                                                      .labelMedium
                                                                      .override(
